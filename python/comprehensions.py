...
# just the squares odd numbers from 1 to 10.
...
names = ['bob', '', 'mary', 'carla', 'sam', 'dean']
# result = [name.capitalize() for name in names if name != '']
print('TODO 10:', ', '.join(name.capitalize() for name in names if name != ''))
